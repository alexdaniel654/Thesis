\chapter{Applying \ttwo Relaxation Under Spin Tagging (TRUST) To Assess Renal Oxygenation}
\label{chap:TRUST}
...
This process is then repeated for another pair of images, however, this time the duration of the \ttwo preparation is increased to a larger \ac{eTE}, this applies a \ttwo weighting to the image in addition to the constant weighting caused by the regular \ac{TE}. Three label/control image pairs were acquired with each \ac{eTE} of 1 ms, 40 ms, 80 ms and 160 ms.\\
