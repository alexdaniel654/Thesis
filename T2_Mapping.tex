...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Histograms of the \ttwo values of voxels within each tissue type measured using each acquisition method.}
