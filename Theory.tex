...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Example magnitude (\subref{fig:theory_mag_phase_mag}) and phase (\subref{fig:theory_mag_phase_phase}) images. Note the phase data is limited to values between $-\pi$ and $\pi$ and as such, phase wrapping can be observed.}
