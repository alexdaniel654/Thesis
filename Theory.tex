...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Geometric distortions in \ac{EPI} caused by eddy currents when phase encode blips are (\subref{fig:theory_epi_blip_l}) positive, (\subref{fig:theory_epi_blip_r}) negative and (\subref{fig:theory_epi_blip_corrected}) corrected via post processing.}
