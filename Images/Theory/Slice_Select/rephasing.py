# -*- coding: utf-8 -*-
"""
Created on Sat Jan  2 18:56:17 2021
...
fig1, (ax2, ax3) = plt.subplots(2, 1, sharex=True, figsize=(5, 4.8))
...
fig1.savefig('slice_select_rephasing.eps', bbox_inches='tight', dpi=300)