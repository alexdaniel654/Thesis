...
In addition to scanning the allograft ex-vivo, an in-vivo post transplant protocol could be used to assess graft function. By proactively identifying the onset and progression of graft dysfunction, treatment could be modified to extend the life of the transplant.
...
One of the aims of the ex-vivo protocol is to minimise time outside the body as a confounding factor. This enables a greater degree of flexibility with regards to scan times and order of scans within the protocol. Tissue degradation occurs relatively quickly after removal from the body and as such, for this work developing an ex-vivo protocol, the tissue was fixed to minimise this process. Samples were transported in \acf{PBS} then transferred into ten times the samples volume of 10\% \acf{NBF} for twenty four hours. After fixation the samples were washed and rehydrated with \ac{PBS} and remain in this solution while being scanned to minimise susceptibility artefacts arising if the sample were scanned either in air or the \ac{NBF}. All samples were scanned at room temperature ($\sim$ 20$\degree$C).
...
\begin{table}[H]
	...
	\begin{tabularx}{1.0\textwidth}{X|X|X}
		...
		Voxel Size (mm)                         & 1 x 1 x 1           & 1.5 x 1.5 x 5            \\ \hline
		FoV (mm)                                & 192 x 192 x 60      & 350 x 350 x 71.5         \\ \hline
		Slices                                  & 60                  & 13                       \\ \hline
		...
		Acquisition Time                        & 53 sec              & 17 sec (1 x Breath Hold)
	\end{tabularx}
...
\begin{table}[H]
	...
	\begin{tabularx}{1.0\textwidth}{X|X|X|X}
		...
		Voxel Size (mm)                           & 0.7 x 0.7 x 1.0                                    & 0.6 x 0.6 x 0.6                                    & 3 x 3 x 5                                                          \\ \hline
		FoV (mm)                                  & 160 x 160 x 50                                     & 192 x 170 x 24                                     & 288 x 288 x 25                                                     \\ \hline
...
The \ttwo mapping protocol makes use of the \ac{GraSE} sequence developed in Chapter \ref{chap:t2_mapping}. This sequence was only implemented at 3T and the sequence parameters are shown in Table \ref{tab:ex_t2_mapping}, an example of the acquisitions at each \ac{TE} is shown in Figure \ref{fig:ex_t2_raw_data}. 

\begin{table}[H]
	\centering
	\begin{tabularx}{1.0\textwidth}{X|X|X}
	\textbf{Parameter}                      & \textbf{3T Ex-Vivo} & \textbf{3T In-Vivo} \\ \hline
	Voxel Size (mm)                         & 0.7 x 0.7 x 1.0     & 3 x 3 x 5           \\ \hline
	FoV (mm)                                & 160 x 160 x 20      & 288 x 288 x 25      \\ \hline
	Slices                                  & 20                  & 5                   \\ \hline
...
\begin{table}[H]
	...
	\begin{tabularx}{1.0\textwidth}{X|X|X|X}
		\textbf{Parameter}                      & \textbf{3T Ex-Vivo} & \textbf{7T Ex-Vivo}            & \textbf{3T In-Vivo}      \\ \hline
		Voxel Size (mm)                         & 0.7 x 0.7 x 1.0     & 0.5 x 0.5 x 1                  & 1.5 x 1.5 x 5            \\ \hline
		FoV (mm)                                & 160 x 160 x 25      & 145 x 145 x 10                 & 288 x 288 x 25           \\ \hline
		...
		Acquisition Time                        & 46 min 25 sec       & 20 min 8 sec                   & 47 sec (3 x Breath Hold)
	\end{tabularx}
...
\begin{figure}[H]
	...
	\caption{Acquisitions at each \acl{TE} at 7T.}
...
\begin{table}[H]
	...
	\begin{tabularx}{1.0\textwidth}{X|X|X}
	\textbf{Parameter}                      & \textbf{3T Ex-Vivo}                                                              & \textbf{3T In-Vivo}                                                              \\ \hline
	Voxel Size (mm)                         & 1.5 x 1.5 x 1.5                                                                  & 1.5 x 1.5 x 5                                                                    \\ \hline
	FoV (mm)                                & 160 x 160 x 51                                                                   & 288 x 288 x 25                                                                   \\ \hline
	Slices                                  & 34                                                                               & 5                                                                                \\ \hline
	Acquisition Mode                        & MS                                                                               & MS                                                                               \\ \hline
	TE (ms)                                 & 72                                                                               & 71                                                                               \\ \hline
...
\begin{table}[H]
	...
	\begin{tabularx}{1.0\textwidth}{X|X|X}
		\textbf{Parameter}                      & \textbf{3T Ex-Vivo} & \textbf{3T In-Vivo}      \\ \hline
		Voxel Size (mm)                         & 2.3 x 2.3 x 2.3     & 3 x 3 x 3                \\ \hline
		FoV (mm)                                & 160 x 160 x 51      & 288 x 288 x 60           \\ \hline
		Slices                                  & 22                  & 20                       \\ \hline
		Acquisition Mode                        & MS                  & MS                       \\ \hline
		TE (ms)                                 & 85                  & 82                       \\ \hline
...
As this tractography protocol was developed from source for renal measures, both the acquisition and the post processing pipeline were verified in the brain. Tractography is a far more mature technique in neuroimaging and as such, verification that the pipeline produces reasonable results on a more familiar anatomy lends confidence to the tractograms produced of the kidneys. The \ac{FOV} of the acquisition was adjusted to cover the whole in-vivo brain but all other parameters were kept constant. The resulting tractogram of the brain produced using this pipeline is shown in Figure \ref{fig:ex_dti_brain_tracts}.
