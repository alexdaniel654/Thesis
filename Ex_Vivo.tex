...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{(i) Kidneys acquired from: (\subref{fig:ex_samples_meat}) the slaughterhouse after it has been fixed. The left hand kidney has been sliced in half; the right hand kidney has the incisions from the meat inspector clearly visible. (\subref{fig:ex_samples_sb}) A sample procured from Veterinary Science post fixation. (ii) Associated \ttwo weighted \ac*{GE} acquisition with TE = 40 ms of each kidney.}
...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Acquisitions at each of the \ac{TI}.}
...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Acquisitions at each \acl{TE}}
