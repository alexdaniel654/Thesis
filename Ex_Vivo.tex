...
\subsubsection{Acquisition}
% Acquisition
\ac{ADC} maps provide an understanding as to how readily molecules can diffuse through a tissue, however they do not provide any information as to what directions the molecules are travelling, to measure this, \ac{DTI} is required. The renal group at \ac{SPMIC} had no existing high resolution in-vivo \ac{DTI} protocol, as such this was specifically developed for this paradigm.
