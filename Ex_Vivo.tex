...
ADC and BOLD with renal biopsy, CKD \cite{inoue_noninvasive_2011}
ADC with renal biopsy, CKD, \cite{zhao_assessment_2014}
Grading renal cancer \cite{goyal_diffusion-weighted_2012}
Biopsy with diffusion \cite{feng_dti_2015}
DTI and prostate cancer \cite{uribe_vivo_2015}  3T and 7T

T1 and ADC with fibrosis, whole organ, rat \cite{friedli_new_2016}
Lots of humans \cite{berchtold_validation_2020}, biopsy
