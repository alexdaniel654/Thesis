...
To further investigate how \tone changes with age, kidneys of 1 day old and 4 week old pigs were scanned. Due to their much smaller size, manually segmenting the cortex and medulla of these samples was not possible, as such the depth based analysis outlined in Section \ref{sec:ex_layers} was used. 
