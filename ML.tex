...
\begin{abstract}
	...
	This work was presented as an oral presentation at the \ac{ISMRM} 28th Annual Meeting (2020) and received a Magna Cum Laude Merit Award \cite{daniel_automated_2020} and has been accepted for publication in Magnetic Resonance in Medicine \cite{daniel_automated_2021}.
\end{abstract}
\newpage
\acresetall
...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{All slices of the raw data from a representative subject of (\subref{fig:ml_raw_hc}) the \ac{HC} cohort, and (\subref{fig:ml_raw_ckd}) the \ac{CKD} cohort.}
	\label{fig:ml_raw}
\end{figure}
