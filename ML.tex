...
\begin{abstract}
	...
	\textit{This work was presented as an oral presentation at the \ac{ISMRM} 28th Annual Meeting (2020) and received a Magna Cum Laude Merit Award \cite{daniel_automated_2020} and has been published as ``Automated renal segmentation in healthy and chronic kidney disease subjects using a convolutional neural network.'' Magnetic Resonance in Medicine, 23 March 2021 doi:~doi.org/10.1002/mrm.28768. \cite{daniel_automated_2021}.}
\end{abstract}
\newpage
\acresetall
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{ML/multi_contrast_kidney.png}
